<template>
	<div>
				...
				<el-card :body-style="{ padding: '0px' }" class="product-container">
					...
					<div>
						...
						<div class="product-bottom">
							<el-button @click="handleClickProductItem({ currentNode: { ...product } })" type="primary" size="mini" class="button"
								>Chi tiết</el-button
							>
						</div>
					</div>
		...
		<chat-modal :isShow="dialogVisible" @handleCloseModal="handleCloseModal" :productInfo="productInfo" />
	</div>
</template>
